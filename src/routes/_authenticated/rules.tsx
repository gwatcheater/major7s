      ...
      <div className="min-h-screen" style={{ backgroundColor: "#243d24", color: "#fff" }}>
        <div className="max-w-2xl mx-auto px-6 py-10 pb-20">
          ...
          <div className="pb-8 mb-8" style={{ borderBottom: "0.5px solid rgba(255,255,255,0.12)" }}>
            <h1 className="font-medium leading-tight mb-3 text-4xl lg:text-5xl" style={{ letterSpacing: "-0.02em", color: "#fff" }}>
              Four Majors.<br />
              Seven Picks.<br />
              <span style={{ color: "var(--gold)" }}>No Mercy.</span>
            </h1>
            <p className="italic text-sm lg:text-base" style={{ color: "rgba(255,255,255,0.5)" }}>
              Everyone's an expert until Sunday.
            </p>
          </div>

          {/* Scoring label */}
          <p className="font-medium uppercase tracking-widest mb-3 text-[10px] lg:text-[11px]" style={{ color: "var(--gold)" }}>
            Scoring
          </p>
          ...
          <div className="rounded-xl flex gap-4 items-start mb-2.5 p-5 lg:p-6" style={{ background: "rgba(201,168,76,0.1)", border: "0.5px solid rgba(201,168,76,0.3)" }}>
            <div className="rounded-lg flex items-center justify-center shrink-0 w-9 h-9 lg:w-10 lg:h-10" style={{ background: "rgba(201,168,76,0.18)", color: "var(--gold)" }}>
            ...
            <div>
              <p className="font-medium mb-1 text-sm lg:text-base" style={{ color: "#d4aa50" }}>Scoring</p>
              <p className="leading-relaxed text-xs lg:text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
              ...
              <div className="flex flex-wrap gap-1.5 mt-2.5">
                {["1st = 1 pt", "5th = 5 pts", "12th = 12 pts", "40th = 40 pts", "65th = 65 pts"].map((eg) => (
                  <span key={eg} className="font-medium px-2 py-0.5 rounded text-[10px] lg:text-[11px]" style={{ background: "rgba(201,168,76,0.1)", border: "0.5px solid rgba(201,168,76,0.25)", color: "#C9A84C" }}>
                    {eg}
                  </span>
                ))}
              </div>
          ...
          <div className="rounded-xl flex gap-4 items-start mb-2.5 p-5 lg:p-6" style={{ background: "rgba(201,168,76,0.16)", border: "1.5px solid rgba(201,168,76,0.55)" }}>
            <div className="rounded-lg flex items-center justify-center shrink-0 w-9 h-9 lg:w-10 lg:h-10" style={{ background: "rgba(201,168,76,0.28)", color: "var(--gold)" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/></svg>
            </div>
            <div>
              <p className="font-medium mb-1 text-sm lg:text-base" style={{ color: "#d4aa50" }}>To win</p>
              <p className="leading-relaxed text-xs lg:text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
          ...
          <div className="rounded-xl flex gap-4 items-start mb-2.5 p-5 lg:p-6" style={{ background: "rgba(226,75,74,0.09)", border: "0.5px solid rgba(226,75,74,0.28)" }}>
            <div className="rounded-lg flex items-center justify-center shrink-0 w-9 h-9 lg:w-10 lg:h-10" style={{ background: "rgba(226,75,74,0.16)", color: "#E24B4A" }}>
            ...
            <div>
              <p className="font-medium mb-1 text-sm lg:text-base" style={{ color: "#e05554" }}>The CUT</p>
              <p className="leading-relaxed text-xs lg:text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
              ...
              <div className="flex flex-wrap gap-1.5 mt-2.5">
                <span className="font-medium px-2.5 py-0.5 rounded text-[11px] lg:text-[12px]" style={{ border: "0.5px solid rgba(226,75,74,0.55)", background: "rgba(226,75,74,0.16)", color: "#E24B4A" }}>
                  CUT = 100 pts
                </span>
              </div>
            </div>
          ...
          <div className="rounded-xl flex gap-4 items-start p-5 lg:p-6" style={{ background: "rgba(239,159,39,0.09)", border: "0.5px solid rgba(239,159,39,0.28)" }}>
            <div className="rounded-lg flex items-center justify-center shrink-0 w-9 h-9 lg:w-10 lg:h-10" style={{ background: "rgba(239,159,39,0.16)", color: "#EF9F27" }}>
            ...
            <div>
              <p className="font-medium mb-1 text-sm lg:text-base" style={{ color: "#EF9F27" }}>Non-finishers</p>
              <p className="leading-relaxed text-xs lg:text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
              ...
              <div className="flex flex-wrap gap-1.5 mt-2.5">
                {["WD - Withdrawal", "DQ - Disqualified", "DNF - Did not finish", "DNS - Did not start", "MDF - Made cut, did not finish"].map((tag) => (
                  <span key={tag} className="font-medium px-2 py-0.5 rounded text-[10px] lg:text-[11px]" style={{ border: "0.5px solid rgba(226,75,74,0.4)", background: "rgba(226,75,74,0.12)", color: "#e05554" }}>
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="grid grid-cols-2 gap-2 lg:gap-3">
            {picks.map((card) => (
              <div key={card.title} className="rounded-lg flex gap-2.5 items-start p-4 lg:p-5" style={{ background: "rgba(255,255,255,0.05)", border: "0.5px solid rgba(255,255,255,0.1)" }}>
                <div className="rounded-md flex items-center justify-center shrink-0 w-7 h-7 lg:w-8 lg:h-8" style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.5)" }}>
                  {card.icon}
                </div>
                <div>
                  <p className="font-medium mb-0.5 text-[11px] lg:text-[12px]" style={{ color: "rgba(255,255,255,0.75)" }}>{card.title}</p>
                  <p className="leading-relaxed text-[11px] lg:text-[12px]" style={{ color: "rgba(255,255,255,0.4)" }}>{card.body}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="rounded-xl flex gap-4 items-start p-5 lg:p-6" style={{ background: "rgba(255,255,255,0.05)", border: "0.5px solid rgba(255,255,255,0.12)" }}>
            <div className="rounded-lg flex items-center justify-center shrink-0 w-9 h-9 lg:w-10 lg:h-10" style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.5)" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
            </div>
            <div className="leading-relaxed text-xs lg:text-sm" style={{ color: "rgba(255,255,255,0.55)" }}>
              <p className="mb-3">
          ...
          <div className="flex flex-wrap gap-1.5 justify-center mt-8 pt-6" style={{ borderTop: "0.5px solid rgba(255,255,255,0.08)" }}>
            {["Masters", "PGA Championship", "US Open", "The Open"].map((m) => (
              <span key={m} className="px-3 py-1 rounded-full text-[10px] lg:text-[11px]" style={{ color: "rgba(255,255,255,0.35)", border: "0.5px solid rgba(255,255,255,0.12)" }}>
                {m}
              </span>
            ))}
          </div>
